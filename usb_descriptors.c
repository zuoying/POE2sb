...
uint8_t const desc_configuration[] = {
    ...
    0x80, // Attributes: Bus Powered, No Remote Wakeup (bit 7 = 1 required by USB 2.0)
    0xFA, // MaxPower 500mA
    ...
    // Endpoint 1 IN: Controller 1 Input
    ...
    // Endpoint 1 OUT: Controller 1 Output (Rumble/LED)
    7, TUSB_DESC_ENDPOINT,
    ...
    // Endpoint 2 IN: Controller 2 Input
    7, TUSB_DESC_ENDPOINT,
    ...
    // Endpoint 2 OUT: Controller 2 Output (Rumble/LED)
    7, TUSB_DESC_ENDPOINT,
